...
#const F_DICT_BUILT_IN_COUNT = F_MEMORY_START + 0x012F
#const F_DICT_USER_START_LSB = F_MEMORY_START + 0x0130
#const F_DICT_USER_START_MSB = F_MEMORY_START + 0x0131
#const F_DICT_USER_COUNT = F_MEMORY_START + 0x0132

#const F_ERROR_MSG_LSB = F_MEMORY_START + 0x0133
#const F_ERROR_MSG_MSB = F_MEMORY_START + 0x0134
