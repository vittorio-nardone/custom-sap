 ...
 * App catalog: GitHub Contents API (HTTPS) - lists roms/apps/asm/*.bin.
 *
...
// GitHub Contents API - lists .bin files in roms/apps/asm (public repo).
#define OTTO_WIFI_APPS_API_URL \
  "https://api.github.com/repos/vittorio-nardone/custom-sap/contents/roms/apps/asm?ref=master"
