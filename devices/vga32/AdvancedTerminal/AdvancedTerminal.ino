...
/*
  ...
  Otto adaptation (Project Otto) — AdvancedTerminal for Otto.
     - Based on FabGL AnsiTerminal; boot banner renamed only.
...
void setup()
{
  ...
  preferences.begin("OttoAdvTerm", false);
  ...
  if (ConfDialogApp::getBootInfo() == BOOTINFO_ENABLED) {
    Terminal.write("* *  AdvancedTerminal for Project OTTO  * *\r\n");
