...
; THE MAX SIZE OF A SINGLE INPUT BUFFER (64 bytes)
#const F_MAX_INPUT_SIZE = 0x40
; THE MAX NUMBER OF INPUT BUFFER 
#const F_MAX_INPUT_BUFFER = 0x02
...
#const F_VARS_START = F_MEMORY_START + (F_MAX_INPUT_SIZE * F_MAX_INPUT_BUFFER)

#const F_INPUT_BUFFER_COUNT = F_VARS_START + 0x0000
#const F_TOKEN_START = F_VARS_START + 0x0001
#const F_TOKEN_COUNT = F_VARS_START + 0x0002
#const F_TOKEN_VALUE = F_VARS_START + 0x0003
#const F_STACK_COUNT = F_VARS_START + 0x0004

#const F_DICT_ADD_USER_LABEL_START = F_VARS_START + 0x0005
#const F_DICT_ADD_USER_LABEL_COUNT = F_VARS_START + 0x0006
...
; #const FREE = F_VARS_START + 0x001E

#const F_DICT_EXEC_BUILT_IN_PTR_PAGE = F_VARS_START + 0x001F
#const F_DICT_EXEC_BUILT_IN_PTR_MSB  = F_VARS_START + 0x0020
#const F_DICT_EXEC_BUILT_IN_PTR_LSB  = F_VARS_START + 0x0021

#const F_EXIT_INTERPRETER_FLAG = F_VARS_START + 0x0022
#const F_EXECUTION_ERROR_FLAG = F_VARS_START + 0x0023
#const F_EXECUTION_ABORT_FLAG = F_VARS_START + 0x0024

#const F_DICT_ADD_USER_START = F_VARS_START + 0x0025
#const F_DICT_ADD_USER_COUNT = F_VARS_START + 0x0026

; #const FREE = F_VARS_START + 0x0027
...
#const F_FIND_TOKEN_START = F_VARS_START + 0x002B
#const F_FIND_TOKEN_COUNT = F_VARS_START + 0x002C
